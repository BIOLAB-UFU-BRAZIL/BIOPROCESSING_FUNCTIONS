...
% Description...:
%                 returns the values of one or more features extracted from
%                 a given signal data set. The features should be 
%                 determined by the user
%                    
% Parameters....: 
%                 data.....-> input data set with signal target epochs
%                             (channels x samples x epoch), if the epochs
%                             are separated in different cell (given a
%                             specified target) each cell should still
%                             follow the dimention pattern and at the end
%                             their features will be concatenated
%                 varargin.-> vector with string names of the features to
%                             be extracted.
%                             The possible features to be extracted are:
...
%
% Return........:
%                 total_features.-> values of the desired features
%                                   extracted from the data set in the user
%                                   required order (channels x features x
%                                   epoch), given that if the data set was
%                                   fed in separate cells then all the
%                                   epochs of different cells will be
