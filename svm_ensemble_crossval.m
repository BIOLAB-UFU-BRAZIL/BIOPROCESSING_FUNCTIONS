...
% Description...:
%                 svm_ensemble_crossval runs an ensemble of SVM classifiers
%                 for the given inputs and targets considering a k-fold
%                 cross validation and returns the confusion matrices of
%                 each fold and the total confusion matrix
%                    
% Parameters....: 
%                 X.-> inputs for the classifiers
%                 Y.-> target vector
%                 K.-> number of folds for the cross validation (optional
%                      input), default: 4
%
% Return........:
%                 total_confusion_test..-> confusion matrix of the average
%                                          from all test results in
%                                          percentage  (#targets x
%                                          #targets)
%                 confusions_test.......-> confusion matrices of test
