...
% Description...:
%                 power_freq_range calculates the power spectral density
%                 from a signal and returns the power from a frequency
...
%                 lowFreq..-> frequencies of the begining of the frequency
%                             interval from which the power will be
%                             calculated [Hz] (optional input), default: 0
%                 highFreq.-> frequencies of the ending of the frequency
%                             interval from which the power will be
%                             calculated [Hz] (must have the same length as
%                             lowFreq) (optional input), default:
%                             sampFreq/2
%
% Return........:
...
for i = 1:length(lowFreq)
    ...
    power(i) = trapz(total_power_norm(lowInd:highInd));
end
