...
% Description...:
%                 percentage_confusion receives a normal confusion matrix
%                 and transforms its values into percentage values
%                 considering that each line sums up to 100%
%                    
% Parameters....: 
%                 pure_confusion.-> input confusion matrix
%
% Return........:
%                 percentage_confusion.-> confusion matrix with its values
%                 in percentage
